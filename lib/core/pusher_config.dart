...
class PusherConfig {
  ...
  String APP_ID = "1874187";
  String API_KEY = "4a9b7206edae6e019bca";
  String SECRET = "d6930a44ed7e7580f689";
    ...
    try {
      ...
      try {
        await _pusher.subscribe(
          ...
          channelName: "chat-message-3",
        );

        log("trying to subscribe to : chat-message-3");
      } catch (e) {
        log(e.toString());
      }
